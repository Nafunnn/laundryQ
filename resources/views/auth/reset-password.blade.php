        ...
        <div class="min-h-screen flex flex-col items-center justify-center py-6 px-4">
            <div class="max-w-[480px] w-full">
                ...
                <div class="p-6 sm:p-8 rounded-2xl bg-white border border-gray-200 shadow-sm">
                    <h1 class="text-slate-900 text-center text-3xl font-semibold">Reset Password</h1>
                    <br>
                    <form class="mt-5 space-y-6" method="POST" action="{{ route('password.update') }}">
                        @csrf
                        <div class="hidden">
                            <label class=" text-slate-900 text-sm font-medium block">Token</label>
                        ...
                        <div class="hidden">
                            <label class="hidden text-slate-900 text-sm font-medium block">Token</label>
                            <div class="relative flex items-center">
