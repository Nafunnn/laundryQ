        ...
        <div class="min-h-screen flex flex-col items-center justify-center py-6 px-4">
            <div class="max-w-[480px] w-full">
                ...
                <div class="p-6 sm:p-8 rounded-2xl bg-white border border-gray-200 shadow-sm">
                    ...
                    <form class="mt-12 space-y-6" method="POST" action="{{ route('register') }}">
                        @csrf
                        <div>
                            ...
                            @include('layout.error', ['field' => 'name'])
                        </div>
                        <div>
                    ...
                    <a href="{{ route('auth.google.redirect') }}">
                        <img src="{{ asset('icons/ic_google.svg') }}" class="w-10 mx-auto"></i>
                    </a>
                    <br>
                    <a href="{{ route('login') }}" class=" text-center ">
                        <p>Already have an account? <span class="text-blue-600 hover:underline font-semibold">Login
                                here</span></p>
                    </a>
                </div>
            </div>
